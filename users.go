...
func (s *Users) PostUsers(ctx context.Context, request components.DtoCreateUserRequest, opts ...operations.Option) (*components.DtoUserResponse, error) {
...
func (s *Users) GetUsersMe(ctx context.Context, opts ...operations.Option) (*components.DtoUserResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
...
func (s *Users) PostUsersSearch(ctx context.Context, request components.TypesUserFilter, opts ...operations.Option) (*components.DtoListUsersResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
