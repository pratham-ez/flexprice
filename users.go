...
func newUsers(rootSDK *Flexprice, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Users {
	return &Users{
		rootSDK:          rootSDK,
...
func (s *Users) CreateServiceAccount(ctx context.Context, request components.DtoCreateUserRequest, opts ...operations.Option) (*operations.PostUsersResponse, error) {
...
// GetWithMe - Get user info
// Get the current user's information
func (s *Users) GetWithMe(ctx context.Context, opts ...operations.Option) (*operations.GetUsersMeResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
...
// Search - List service accounts with filters
// Search and filter service accounts by type, roles, etc.
func (s *Users) Search(ctx context.Context, request components.TypesUserFilter, opts ...operations.Option) (*operations.PostUsersSearchResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	res := &operations.PostUsersSearchResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
