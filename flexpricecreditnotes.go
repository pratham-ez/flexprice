...
type FlexpriceCreditnotes struct {
	rootSDK          *Flexprice
	sdkConfiguration config.SDKConfiguration
	hooks            *hooks.Hooks
}

func newFlexpriceCreditnotes(rootSDK *Flexprice, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *FlexpriceCreditnotes {
	return &FlexpriceCreditnotes{
		rootSDK:          rootSDK,
...
func (s *FlexpriceCreditnotes) Get(ctx context.Context, id string, opts ...operations.Option) (*operations.GetCreditnotesIDResponse, error) {
	...
	res := &operations.GetCreditnotesIDResponse{
