...
func newRbac(rootSDK *Flexprice, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Rbac {
	return &Rbac{
		rootSDK:          rootSDK,
...
// ListRoles - List all RBAC roles
// Returns all available roles with their permissions, names, and descriptions
func (s *Rbac) ListRoles(ctx context.Context, opts ...operations.Option) (*operations.GetRbacRolesResponse, error) {
	...
	res := &operations.GetRbacRolesResponse{
...
// GetRole - Get a specific RBAC role
// Returns details of a specific role including permissions, name, and description
func (s *Rbac) GetRole(ctx context.Context, id string, opts ...operations.Option) (*operations.GetRbacRolesIDResponse, error) {
	...
	res := &operations.GetRbacRolesIDResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
