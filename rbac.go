...
func (s *Rbac) GetRbacRoles(ctx context.Context, opts ...operations.Option) (map[string]any, error) {
...
func (s *Rbac) GetRbacRolesID(ctx context.Context, id string, opts ...operations.Option) (map[string]any, error) {
