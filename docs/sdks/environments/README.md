...
with Flexprice(
    ...
    res = f_client.environments.list()
...
**[models.DtoListEnvironmentsResponse](../../models/dtolistenvironmentsresponse.md)**
...
with Flexprice(
    ...
    res = f_client.environments.create(name="<value>", type_="<value>")
...
with Flexprice(
    ...
    res = f_client.environments.get(id="<id>")
...
with Flexprice(
    ...
    res = f_client.environments.update(id="<id>")
