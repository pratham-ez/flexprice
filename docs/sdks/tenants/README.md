...
func main() {
    ...
    res, err := s.Tenants.GetBilling(ctx)
    if err != nil {
        log.Fatal(err)
    }
...
**[*operations.GetTenantBillingResponse](../../models/operations/gettenantbillingresponse.md), error**
...
func main() {
    ...
    res, err := s.Tenants.Create(ctx, components.DtoCreateTenantRequest{
        Name: "<value>",
    })
    if err != nil {
        log.Fatal(err)
...
**[*operations.PostTenantsResponse](../../models/operations/posttenantsresponse.md), error**
...
func main() {
    ...
    res, err := s.Tenants.Update(ctx, components.DtoUpdateTenantRequest{})
    if err != nil {
        log.Fatal(err)
    }
    if res.DtoTenantResponse != nil {
...
**[*operations.PutTenantsUpdateResponse](../../models/operations/puttenantsupdateresponse.md), error**
...
func main() {
    ...
    res, err := s.Tenants.GetByID(ctx, "<id>")
    if err != nil {
        log.Fatal(err)
    }
    if res.DtoTenantResponse != nil {
...
**[*operations.GetTenantsIDResponse](../../models/operations/gettenantsidresponse.md), error**
