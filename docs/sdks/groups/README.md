...
async function run() {
  const result = await flexprice.groups.create({
    entityType: "<value>",
    lookupKey: "<value>",
    name: "<value>",
  });
...
import { groupsCreate } from "@flexprice/sdk/funcs/groupsCreate.js";
...
async function run() {
  const res = await groupsCreate(flexprice, {
    entityType: "<value>",
    lookupKey: "<value>",
    name: "<value>",
  });
...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [models.DtoCreateGroupRequest](../../models/dtocreategrouprequest.md)                                                                                                          | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
...
**Promise\<[models.DtoGroupResponse](../../models/dtogroupresponse.md)\>**
...
async function run() {
  const result = await flexprice.groups.search();
...
```typescript
import { FlexpriceCore } from "@flexprice/sdk/core.js";
import { groupsSearch } from "@flexprice/sdk/funcs/groupsSearch.js";
...
async function run() {
  const res = await groupsSearch(flexprice);
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
    console.log("groupsSearch failed:", res.error);
  }
}
...
**Promise\<[models.DtoListGroupsResponse](../../models/dtolistgroupsresponse.md)\>**
...
async function run() {
  const result = await flexprice.groups.getById("<id>");
...
```typescript
import { FlexpriceCore } from "@flexprice/sdk/core.js";
import { groupsGetById } from "@flexprice/sdk/funcs/groupsGetById.js";
...
async function run() {
  const res = await groupsGetById(flexprice, "<id>");
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
    console.log("groupsGetById failed:", res.error);
  }
}
...
async function run() {
  await flexprice.groups.delete("<id>");
...
```typescript
import { FlexpriceCore } from "@flexprice/sdk/core.js";
import { groupsDelete } from "@flexprice/sdk/funcs/groupsDelete.js";
...
async function run() {
  const res = await groupsDelete(flexprice, "<id>");
  if (res.ok) {
    const { value: result } = res;
