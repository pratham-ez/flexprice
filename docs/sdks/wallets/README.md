...
func main() {
    ...
    res, err := s.Wallets.ListCustomerWallets(ctx, nil, gosdk.Pointer(false), nil)
    if err != nil {
        log.Fatal(err)
    }
...
**[*operations.GetCustomersWalletsResponse](../../models/operations/getcustomerswalletsresponse.md), error**
...
func main() {
    ...
    res, err := s.Wallets.GetByCustomerID(ctx, "<id>")
    if err != nil {
        log.Fatal(err)
    }
    if res.DtoWalletResponses != nil {
...
**[*operations.GetCustomersIDWalletsResponse](../../models/operations/getcustomersidwalletsresponse.md), error**
...
func main() {
    ...
    res, err := s.Wallets.Create(ctx, components.DtoCreateWalletRequest{
...
**[*operations.PostWalletsResponse](../../models/operations/postwalletsresponse.md), error**
...
**[*operations.GetWalletsIDResponse](../../models/operations/getwalletsidresponse.md), error**
...
func main() {
    ...
    res, err := s.Wallets.Update(ctx, "<id>", components.DtoUpdateWalletRequest{})
    if err != nil {
        log.Fatal(err)
    }
    if res.DtoWalletResponse != nil {
...
**[*operations.PutWalletsIDResponse](../../models/operations/putwalletsidresponse.md), error**
...
func main() {
    ...
    res, err := s.Wallets.GetBalanceRealTime(ctx, "<id>")
    if err != nil {
        log.Fatal(err)
    }
...
**[*operations.GetWalletsIDBalanceRealTimeResponse](../../models/operations/getwalletsidbalancerealtimeresponse.md), error**
...
<!-- UsageSnippet language="go" operationID="post_/wallets/{id}/debit" method="post" path="/wallets/{id}/debit" -->
```go
package main
...
func main() {
    ...
    res, err := s.Wallets.Debit(ctx, "<id>", components.DtoManualBalanceDebitRequest{
...
**[*operations.PostWalletsIDDebitResponse](../../models/operations/postwalletsiddebitresponse.md), error**
...
func main() {
    ...
    res, err := s.Wallets.Terminate(ctx, "<id>")
    if err != nil {
        log.Fatal(err)
    }
    if res.DtoWalletResponse != nil {
...
**[*operations.PostWalletsIDTerminateResponse](../../models/operations/postwalletsidterminateresponse.md), error**
...
func main() {
    ...
    res, err := s.Wallets.TopUp(ctx, "<id>", components.DtoTopUpWalletRequest{
...
**[*operations.PostWalletsIDTopUpResponse](../../models/operations/postwalletsidtopupresponse.md), error**
...
func main() {
    ...
    res, err := s.Wallets.GetTransactions(ctx, operations.GetWalletsIDTransactionsRequest{
...
**[*operations.GetWalletsIDTransactionsResponse](../../models/operations/getwalletsidtransactionsresponse.md), error**
