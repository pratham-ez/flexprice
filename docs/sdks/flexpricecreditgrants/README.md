...
func main() {
    ...
    res, err := s.CreditGrants.Create(ctx, components.DtoCreateCreditGrantRequest{
...
**[*operations.PostCreditgrantsResponse](../../models/operations/postcreditgrantsresponse.md), error**
...
func main() {
    ...
    res, err := s.CreditGrants.GetByID(ctx, "<id>")
    if err != nil {
        log.Fatal(err)
    }
    if res.DtoCreditGrantResponse != nil {
...
**[*operations.GetCreditgrantsIDResponse](../../models/operations/getcreditgrantsidresponse.md), error**
...
func main() {
    ...
    res, err := s.CreditGrants.Update(ctx, "<id>", components.DtoUpdateCreditGrantRequest{})
    if err != nil {
        log.Fatal(err)
    }
    if res.DtoCreditGrantResponse != nil {
...
**[*operations.PutCreditgrantsIDResponse](../../models/operations/putcreditgrantsidresponse.md), error**
...
func main() {
    ...
    res, err := s.CreditGrants.Delete(ctx, "<id>")
    if err != nil {
        log.Fatal(err)
    }
    if res.GinH != nil {
...
**[*operations.DeleteCreditgrantsIDResponse](../../models/operations/deletecreditgrantsidresponse.md), error**
...
func main() {
    ...
    res, err := s.CreditGrants.GetForPlan(ctx, "<id>")
    if err != nil {
        log.Fatal(err)
    }
...
**[*operations.GetPlansIDCreditgrantsResponse](../../models/operations/getplansidcreditgrantsresponse.md), error**
