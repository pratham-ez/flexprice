...
func main() {
    ...
    res, err := s.Payments.List(ctx, operations.GetPaymentsRequest{})
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.Payments.Create(ctx, components.DtoCreatePaymentRequest{
        Amount: "910.96",
...
**[*operations.PostPaymentsResponse](../../models/operations/postpaymentsresponse.md), error**
...
func main() {
    ...
    res, err := s.Payments.GetByID(ctx, "<id>")
    if err != nil {
        log.Fatal(err)
    }
    if res.DtoPaymentResponse != nil {
...
func main() {
    ...
    res, err := s.Payments.Update(ctx, "<id>", components.DtoUpdatePaymentRequest{})
    if err != nil {
        log.Fatal(err)
    }
    if res.DtoPaymentResponse != nil {
...
**[*operations.PutPaymentsIDResponse](../../models/operations/putpaymentsidresponse.md), error**
...
func main() {
    ...
    res, err := s.Payments.Delete(ctx, "<id>")
    if err != nil {
        log.Fatal(err)
    }
    if res.GinH != nil {
...
**[*operations.DeletePaymentsIDResponse](../../models/operations/deletepaymentsidresponse.md), error**
...
func main() {
    ...
    res, err := s.Payments.Process(ctx, "<id>")
    if err != nil {
        log.Fatal(err)
    }
    if res.DtoPaymentResponse != nil {
...
**[*operations.PostPaymentsIDProcessResponse](../../models/operations/postpaymentsidprocessresponse.md), error**
