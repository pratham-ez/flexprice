...
async function run() {
  const result = await flexprice.plans.list();
...
import { plansList } from "@flexprice/sdk/funcs/plansList.js";
...
async function run() {
  const res = await plansList(flexprice);
  if (res.ok) {
...
**Promise\<[models.DtoListPlansResponse](../../models/dtolistplansresponse.md)\>**
...
async function run() {
  const result = await flexprice.plans.create({
    name: "<value>",
  });
...
```typescript
import { FlexpriceCore } from "@flexprice/sdk/core.js";
import { plansCreate } from "@flexprice/sdk/funcs/plansCreate.js";
...
async function run() {
  const res = await plansCreate(flexprice, {
    name: "<value>",
  });
  if (res.ok) {
    const { value: result } = res;
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [models.DtoCreatePlanRequest](../../models/dtocreateplanrequest.md)                                                                                                            | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
**Promise\<[models.DtoPlanResponse](../../models/dtoplanresponse.md)\>**
...
async function run() {
  const result = await flexprice.plans.search({});
...
```typescript
import { FlexpriceCore } from "@flexprice/sdk/core.js";
import { plansSearch } from "@flexprice/sdk/funcs/plansSearch.js";
...
async function run() {
  const res = await plansSearch(flexprice, {});
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [models.TypesPlanFilter](../../models/typesplanfilter.md)                                                                                                                      | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
async function run() {
  const result = await flexprice.plans.getById("<id>");
...
```typescript
import { FlexpriceCore } from "@flexprice/sdk/core.js";
import { plansGetById } from "@flexprice/sdk/funcs/plansGetById.js";
...
async function run() {
  const res = await plansGetById(flexprice, "<id>");
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
    console.log("plansGetById failed:", res.error);
  }
}
...
async function run() {
  const result = await flexprice.plans.update("<id>", {});
...
```typescript
import { FlexpriceCore } from "@flexprice/sdk/core.js";
import { plansUpdate } from "@flexprice/sdk/funcs/plansUpdate.js";
...
async function run() {
  const res = await plansUpdate(flexprice, "<id>", {});
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
...
async function run() {
  const result = await flexprice.plans.delete("<id>");
...
```typescript
import { FlexpriceCore } from "@flexprice/sdk/core.js";
import { plansDelete } from "@flexprice/sdk/funcs/plansDelete.js";
...
async function run() {
  const res = await plansDelete(flexprice, "<id>");
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
...
async function run() {
  const result = await flexprice.plans.syncSubscriptions("<id>");
...
```typescript
import { FlexpriceCore } from "@flexprice/sdk/core.js";
import { plansSyncSubscriptions } from "@flexprice/sdk/funcs/plansSyncSubscriptions.js";
...
async function run() {
  const res = await plansSyncSubscriptions(flexprice, "<id>");
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
    console.log("plansSyncSubscriptions failed:", res.error);
  }
}
...
async function run() {
  const result = await flexprice.plans.getEntitlements("<id>");
...
```typescript
import { FlexpriceCore } from "@flexprice/sdk/core.js";
import { plansGetEntitlements } from "@flexprice/sdk/funcs/plansGetEntitlements.js";
...
async function run() {
  const res = await plansGetEntitlements(flexprice, "<id>");
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
    console.log("plansGetEntitlements failed:", res.error);
  }
}
