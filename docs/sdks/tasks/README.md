...
func main() {
    ...
    res, err := s.Tasks.List(ctx, operations.GetTasksRequest{})
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.Tasks.Create(ctx, components.DtoCreateTaskRequest{
...
**[*operations.PostTasksResponse](../../models/operations/posttasksresponse.md), error**
...
func main() {
    ...
    res, err := s.Tasks.GetResult(ctx, "<id>")
    if err != nil {
        log.Fatal(err)
    }
...
**[*operations.GetTasksResultResponse](../../models/operations/gettasksresultresponse.md), error**
...
**[*operations.GetTasksIDResponse](../../models/operations/gettasksidresponse.md), error**
...
func main() {
    ...
    res, err := s.Tasks.UpdateStatus(ctx, "<id>", components.DtoUpdateTaskStatusRequest{
...
**[*operations.PutTasksIDStatusResponse](../../models/operations/puttasksidstatusresponse.md), error**
