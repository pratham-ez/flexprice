...
async function run() {
  const result = await flexprice.coupons.list();
...
import { couponsList } from "@flexprice/sdk/funcs/couponsList.js";
...
async function run() {
  const res = await couponsList(flexprice);
  if (res.ok) {
...
**Promise\<[models.DtoListCouponsResponse](../../models/dtolistcouponsresponse.md)\>**
...
async function run() {
  const result = await flexprice.coupons.create({
    cadence: "forever",
    name: "<value>",
    type: "percentage",
  });
...
```typescript
import { FlexpriceCore } from "@flexprice/sdk/core.js";
import { couponsCreate } from "@flexprice/sdk/funcs/couponsCreate.js";
...
async function run() {
  const res = await couponsCreate(flexprice, {
    cadence: "forever",
    name: "<value>",
    type: "percentage",
  });
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [models.DtoCreateCouponRequest](../../models/dtocreatecouponrequest.md)                                                                                                        | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
**Promise\<[models.DtoCouponResponse](../../models/dtocouponresponse.md)\>**
...
async function run() {
  const result = await flexprice.coupons.getById("<id>");
...
```typescript
import { FlexpriceCore } from "@flexprice/sdk/core.js";
import { couponsGetById } from "@flexprice/sdk/funcs/couponsGetById.js";
...
async function run() {
  const res = await couponsGetById(flexprice, "<id>");
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
    console.log("couponsGetById failed:", res.error);
  }
}
...
async function run() {
  const result = await flexprice.coupons.update("<id>", {});
...
```typescript
import { FlexpriceCore } from "@flexprice/sdk/core.js";
import { couponsUpdate } from "@flexprice/sdk/funcs/couponsUpdate.js";
...
async function run() {
  const res = await couponsUpdate(flexprice, "<id>", {});
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
...
async function run() {
  const result = await flexprice.coupons.delete("<id>");
...
```typescript
import { FlexpriceCore } from "@flexprice/sdk/core.js";
import { couponsDelete } from "@flexprice/sdk/funcs/couponsDelete.js";
...
async function run() {
  const res = await couponsDelete(flexprice, "<id>");
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
