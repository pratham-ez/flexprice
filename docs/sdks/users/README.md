...
func main() {
    ...
    res, err := s.Users.CreateServiceAccount(ctx, components.DtoCreateUserRequest{
        Roles: []string{},
...
func main() {
    ...
    res, err := s.Users.Search(ctx, components.TypesUserFilter{})
    if err != nil {
        log.Fatal(err)
    }
...
**[*operations.PostUsersSearchResponse](../../models/operations/postuserssearchresponse.md), error**
