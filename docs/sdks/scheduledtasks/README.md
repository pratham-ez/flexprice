...
async function run() {
  const result = await flexprice.scheduledTasks.list();
...
import { scheduledTasksList } from "@flexprice/sdk/funcs/scheduledTasksList.js";
...
async function run() {
  const res = await scheduledTasksList(flexprice);
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
    console.log("scheduledTasksList failed:", res.error);
  }
}
...
**Promise\<[models.DtoListScheduledTasksResponse](../../models/dtolistscheduledtasksresponse.md)\>**
...
async function run() {
  const result = await flexprice.scheduledTasks.create({
    connectionId: "<id>",
    entityType: "invoice",
    interval: "custom",
    jobConfig: {},
...
```typescript
import { FlexpriceCore } from "@flexprice/sdk/core.js";
import { scheduledTasksCreate } from "@flexprice/sdk/funcs/scheduledTasksCreate.js";
...
async function run() {
  const res = await scheduledTasksCreate(flexprice, {
    connectionId: "<id>",
    entityType: "invoice",
    interval: "custom",
    jobConfig: {},
  ...
  if (res.ok) {
    ...
    console.log("scheduledTasksCreate failed:", res.error);
  }
}
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [models.DtoCreateScheduledTaskRequest](../../models/dtocreatescheduledtaskrequest.md)                                                                                          | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
**Promise\<[models.DtoScheduledTaskResponse](../../models/dtoscheduledtaskresponse.md)\>**
...
async function run() {
  const result = await flexprice.scheduledTasks.get("<id>");
...
```typescript
import { FlexpriceCore } from "@flexprice/sdk/core.js";
import { scheduledTasksGet } from "@flexprice/sdk/funcs/scheduledTasksGet.js";
...
async function run() {
  const res = await scheduledTasksGet(flexprice, "<id>");
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
    console.log("scheduledTasksGet failed:", res.error);
  }
}
...
async function run() {
  const result = await flexprice.scheduledTasks.update("<id>", {
    enabled: true,
  });
...
```typescript
import { FlexpriceCore } from "@flexprice/sdk/core.js";
import { scheduledTasksUpdate } from "@flexprice/sdk/funcs/scheduledTasksUpdate.js";
...
async function run() {
  const res = await scheduledTasksUpdate(flexprice, "<id>", {
    enabled: true,
  });
  if (res.ok) {
    const { value: result } = res;
    ...
    console.log("scheduledTasksUpdate failed:", res.error);
  }
}
...
async function run() {
  await flexprice.scheduledTasks.delete("<id>");
...
```typescript
import { FlexpriceCore } from "@flexprice/sdk/core.js";
import { scheduledTasksDelete } from "@flexprice/sdk/funcs/scheduledTasksDelete.js";
...
async function run() {
  const res = await scheduledTasksDelete(flexprice, "<id>");
  if (res.ok) {
    const { value: result } = res;
    
  } else {
    console.log("scheduledTasksDelete failed:", res.error);
  }
}
...
async function run() {
  const result = await flexprice.scheduledTasks.triggerRun("<id>");
...
```typescript
import { FlexpriceCore } from "@flexprice/sdk/core.js";
import { scheduledTasksTriggerRun } from "@flexprice/sdk/funcs/scheduledTasksTriggerRun.js";
...
async function run() {
  const res = await scheduledTasksTriggerRun(flexprice, "<id>");
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
    console.log("scheduledTasksTriggerRun failed:", res.error);
  }
}
...
**Promise\<[models.DtoTriggerForceRunResponse](../../models/dtotriggerforcerunresponse.md)\>**
