...
| `period_end`                                            | *Optional[str]*                                         | :heavy_minus_sign:                                      | period_end for this line item (if applicable)           |
| `period_start`                                          | *Optional[str]*                                         | :heavy_minus_sign:                                      | period_start for this line item (if applicable)         |
