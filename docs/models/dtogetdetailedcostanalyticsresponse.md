...
```typescript
import { DtoGetDetailedCostAnalyticsResponse } from "@flexprice/sdk/models";
...
| ---------------------------------------------------------------- | ---------------------------------------------------------------- | ---------------------------------------------------------------- | ---------------------------------------------------------------- |
| `costAnalytics`                                                  | [models.DtoCostAnalyticItem](../models/dtocostanalyticitem.md)[] | :heavy_minus_sign:                                               | Cost analytics array (flattened from nested structure)           |
