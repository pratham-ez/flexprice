...
func (d *DtoCreateWalletRequest) GetAutoTopupAmount() *string {
	if d == nil {
		return nil
	}
...
func (d *DtoCreateWalletRequest) GetAutoTopupMinBalance() *string {
	if d == nil {
		return nil
	}
...
func (d *DtoCreateWalletRequest) GetAutoTopupTrigger() *TypesAutoTopupTrigger {
	if d == nil {
		return nil
	}
