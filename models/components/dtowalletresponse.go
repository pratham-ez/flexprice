...
func (d *DtoWalletResponse) GetAutoTopupAmount() *string {
	if d == nil {
		return nil
	}
...
func (d *DtoWalletResponse) GetAutoTopupMinBalance() *string {
	if d == nil {
		return nil
	}
...
func (d *DtoWalletResponse) GetAutoTopupTrigger() *TypesAutoTopupTrigger {
	if d == nil {
		return nil
	}
