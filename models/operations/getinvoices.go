...
type GetInvoicesQueryParamOrder string

const (
	GetInvoicesQueryParamOrderAsc  GetInvoicesQueryParamOrder = "asc"
	GetInvoicesQueryParamOrderDesc GetInvoicesQueryParamOrder = "desc"
)

func (e GetInvoicesQueryParamOrder) ToPointer() *GetInvoicesQueryParamOrder {
	return &e
}
func (e *GetInvoicesQueryParamOrder) UnmarshalJSON(data []byte) error {
	var v string
	if err := json.Unmarshal(data, &v); err != nil {
		return err
	}
	...
	case "asc":
		fallthrough
	case "desc":
		*e = GetInvoicesQueryParamOrder(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetInvoicesQueryParamOrder: %v", v)
	}
}
...
type GetInvoicesQueryParamStatus string

const (
	GetInvoicesQueryParamStatusPublished GetInvoicesQueryParamStatus = "published"
	GetInvoicesQueryParamStatusDeleted   GetInvoicesQueryParamStatus = "deleted"
	GetInvoicesQueryParamStatusArchived  GetInvoicesQueryParamStatus = "archived"
)

func (e GetInvoicesQueryParamStatus) ToPointer() *GetInvoicesQueryParamStatus {
	return &e
}
func (e *GetInvoicesQueryParamStatus) UnmarshalJSON(data []byte) error {
	var v string
	if err := json.Unmarshal(data, &v); err != nil {
		return err
	}
	...
	case "deleted":
		fallthrough
	case "archived":
		*e = GetInvoicesQueryParamStatus(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetInvoicesQueryParamStatus: %v", v)
	}
}
...
type GetInvoicesRequest struct {
	...
	Order       *GetInvoicesQueryParamOrder `queryParam:"style=form,explode=true,name=order"`
	...
	Status        *GetInvoicesQueryParamStatus `queryParam:"style=form,explode=true,name=status"`
...
func (g *GetInvoicesRequest) GetOrder() *GetInvoicesQueryParamOrder {
	if g == nil {
		return nil
	}
	return g.Order
...
func (g *GetInvoicesRequest) GetStatus() *GetInvoicesQueryParamStatus {
	if g == nil {
		return nil
	}
	return g.Status
...
func (g GetInvoicesResponse) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(g, "", false)
}

func (g *GetInvoicesResponse) UnmarshalJSON(data []byte) error {
	if err := utils.UnmarshalJSON(data, &g, "", false, nil); err != nil {
		return err
	}
	return nil
...
func (g *GetInvoicesResponse) GetHTTPMeta() components.HTTPMetadata {
	if g == nil {
...
func (g *GetInvoicesResponse) GetDtoListInvoicesResponse() *components.DtoListInvoicesResponse {
	if g == nil {
		return nil
	}
	return g.DtoListInvoicesResponse
}
