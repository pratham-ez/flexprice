...
> {
  const input: operations.GetAddonsRequest | undefined = {
    addonIds: addonIds,
    addonType: addonType,
    endTime: endTime,
    expand: expand,
  ...
  const parsed = safeParse(
    input,
    (value) =>
      z.parse(z.optional(operations.GetAddonsRequest$outboundSchema), value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.DtoListAddonsResponse$inboundSchema),
