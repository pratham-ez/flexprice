 ...
 */
export function walletsListCustomerWallets(
...
> {
  const input: operations.GetCustomersWalletsRequest | undefined = {
    id: id,
  ...
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(operations.GetCustomersWalletsRequest$outboundSchema),
        value,
      ),
