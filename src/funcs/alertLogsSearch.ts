 ...
 */
export function alertLogsSearch(
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(models.TypesAlertLogFilter$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.DtoListAlertLogsResponse$inboundSchema),
