 ...
 */
export function costsGetAnalytics(
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(models.DtoGetCostAnalyticsRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.DtoGetDetailedCostAnalyticsResponse$inboundSchema),
