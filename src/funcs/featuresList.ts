...
> {
  const input: operations.GetFeaturesRequest | undefined = {
    endTime: endTime,
    expand: expand,
  ...
  const parsed = safeParse(
    input,
    (value) =>
      z.parse(z.optional(operations.GetFeaturesRequest$outboundSchema), value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.DtoListFeaturesResponse$inboundSchema),
