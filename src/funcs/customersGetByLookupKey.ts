 ...
 */
export function customersGetByLookupKey(
...
> {
  const input: operations.GetCustomersLookupLookupKeyRequest = {
    lookupKey: lookupKey,
  };
  ...
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.GetCustomersLookupLookupKeyRequest$outboundSchema,
        value,
      ),
  ...
  const path = pathToFunc("/customers/lookup/{lookup_key}")(pathParams);
