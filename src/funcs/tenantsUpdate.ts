...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(models.DtoUpdateTenantRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.DtoTenantResponse$inboundSchema),
