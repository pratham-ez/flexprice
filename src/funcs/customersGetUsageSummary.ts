 ...
 */
export function customersGetUsageSummary(
...
> {
  const input: operations.GetCustomersUsageRequest | undefined = {
  ...
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(operations.GetCustomersUsageRequest$outboundSchema),
        value,
      ),
