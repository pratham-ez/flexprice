 ...
 */
export function pricesBulkCreate(
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(models.DtoCreateBulkPriceRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, models.DtoCreateBulkPriceResponse$inboundSchema),
