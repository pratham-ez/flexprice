...
/** @internal */
export const GetSubscriptionsOrder$outboundSchema: z.ZodMiniEnum<
  typeof GetSubscriptionsOrder
> = z.enum(GetSubscriptionsOrder);

/** @internal */
export const GetSubscriptionsStatus$outboundSchema: z.ZodMiniEnum<
  typeof GetSubscriptionsStatus
> = z.enum(GetSubscriptionsStatus);
...
> = z.pipe(
  z.object({
    ...
    order: z.optional(GetSubscriptionsOrder$outboundSchema),
    planId: z.optional(z.string()),
    startTime: z.optional(z.string()),
    status: z.optional(GetSubscriptionsStatus$outboundSchema),
