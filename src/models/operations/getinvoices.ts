...
/** @internal */
export const GetInvoicesOrder$outboundSchema: z.ZodMiniEnum<
  typeof GetInvoicesOrder
> = z.enum(GetInvoicesOrder);
...
> = z.pipe(
  z.object({
    ...
    order: z.optional(GetInvoicesOrder$outboundSchema),
