...
class Environments(BaseSDK):
    def list(
        ...
        *,
        ...
        status: Optional[models.GetEnvironmentsQueryParamStatus] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.DtoListEnvironmentsResponse:
        r"""Get environments
        ...
        request = models.GetEnvironmentsRequest(
            expand=expand,
            limit=limit,
            offset=offset,
            order=order,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.DtoListEnvironmentsResponse, http_res)
    ...
    def get(
        ...
        *,
        ...
        request = models.GetEnvironmentsIDRequest(
            id=id,
        )
    ...
    def update(
        ...
        *,
        ...
        request = models.PutEnvironmentsIDRequest(
            id=id,
