...
class DtoPriceResponseTypedDict(TypedDict):
    ...
    r"""ConversionRate is the rate of the price unit to the base currency
    ...
    r"""DisplayPriceUnitAmount is the formatted amount with price unit symbol
    ...
    min_quantity: NotRequired[float]
    ...
    r"""PriceUnit 3 digit ISO currency code in lowercase ex btc
    For BTC: btc
    """
    price_unit_amount: NotRequired[str]
    r"""PriceUnitAmount is the amount stored in price unit
    For BTC: 0.00000001 means 0.00000001 BTC
    """
    price_unit_id: NotRequired[str]
    r"""PriceUnitID is the id of the price unit"""
    price_unit_tiers: NotRequired[List[PricePriceTierTypedDict]]
    r"""PriceUnitTiers are the tiers for the price unit"""
