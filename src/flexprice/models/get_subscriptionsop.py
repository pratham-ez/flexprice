...
GetSubscriptionsQueryParamOrder = Literal[
    "asc",
    "desc",
]


GetSubscriptionsQueryParamStatus = Literal[
    "published",
    "deleted",
    "archived",
]
...
class GetSubscriptionsRequestTypedDict(TypedDict):
    ...
    order: NotRequired[GetSubscriptionsQueryParamOrder]
    plan_id: NotRequired[str]
    r"""PlanID filters by plan ID"""
    start_time: NotRequired[str]
    status: NotRequired[GetSubscriptionsQueryParamStatus]
...
class GetSubscriptionsRequest(BaseModel):
    ...
    order: Annotated[
        Optional[GetSubscriptionsQueryParamOrder],
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = None
    ...
    status: Annotated[
        Optional[GetSubscriptionsQueryParamStatus],
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = None
