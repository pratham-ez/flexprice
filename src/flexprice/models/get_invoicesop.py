...
GetInvoicesQueryParamOrder = Literal[
    "asc",
    "desc",
]
...
GetInvoicesQueryParamStatus = Literal[
    "published",
    "deleted",
    "archived",
]
...
class GetInvoicesRequestTypedDict(TypedDict):
    ...
    order: NotRequired[GetInvoicesQueryParamOrder]
    ...
    status: NotRequired[GetInvoicesQueryParamStatus]
...
class GetInvoicesRequest(BaseModel):
    ...
    order: Annotated[
        Optional[GetInvoicesQueryParamOrder],
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = None
    ...
    status: Annotated[
        Optional[GetInvoicesQueryParamStatus],
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = None
