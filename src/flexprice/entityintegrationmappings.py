...
class EntityIntegrationMappings(BaseSDK):
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.DtoListEntityIntegrationMappingsResponse, http_res
            )
    ...
    def get_by_id(
        ...
        *,
        ...
        request = models.GetEntityIntegrationMappingsIDRequest(
            id=id,
        )
    ...
    def delete(
        ...
        *,
        ...
        request = models.DeleteEntityIntegrationMappingsIDRequest(
            id=id,
        )
