...
class Subscriptions(BaseSDK):
    def list(
        ...
        *,
        request: Union[
            models.GetSubscriptionsRequest, models.GetSubscriptionsRequestTypedDict
        ] = models.GetSubscriptionsRequest(),
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, models.GetSubscriptionsRequest)
        request = cast(models.GetSubscriptionsRequest, request)
    ...
    def add_addon(
        ...
        *,
        ...
        req = self._build_request(
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request, False, False, "json", models.DtoAddAddonToSubscriptionRequest
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
    ...
    def update_line_item(
        ...
        *,
        ...
        request = models.PutSubscriptionsLineitemsIDRequest(
            id=id,
    ...
    async def update_line_item_async(
        self,
        *,
        id: str,
        amount: Optional[str] = None,
    ...
    def delete_line_item(
        ...
        *,
        ...
        request = models.DeleteSubscriptionsLineitemsIDRequest(
            id=id,
    ...
    async def delete_line_item_async(
        self,
        *,
        id: str,
        effective_from: Optional[str] = None,
    ...
    def get(
        ...
        *,
        ...
        request = models.GetSubscriptionsIDRequest(
            id=id,
        )
    ...
    def activate(
        ...
        *,
        ...
        request = models.PostSubscriptionsIDActivateRequest(
            id=id,
    ...
    def cancel(
        ...
        *,
        ...
        request = models.PostSubscriptionsIDCancelRequest(
            id=id,
    ...
    def execute_change(
        ...
        *,
        ...
        request = models.PostSubscriptionsIDChangeExecuteRequest(
            id=id,
    ...
    async def execute_change_async(
        self,
        *,
        id: str,
        billing_cadence: models.TypesBillingCadence,
    ...
    def preview_plan_change(
        ...
        *,
        ...
        request = models.PostSubscriptionsIDChangePreviewRequest(
            id=id,
            body=models.DtoSubscriptionChangeRequest(
                billing_cadence=billing_cadence,
                billing_cycle=billing_cycle,
    ...
    async def preview_plan_change_async(
        self,
        *,
        id: str,
        billing_cadence: models.TypesBillingCadence,
    ...
    def get_entitlements(
        ...
        *,
        ...
        request = models.GetSubscriptionsIDEntitlementsRequest(
            id=id,
    ...
    def get_upcoming_grants(
        ...
        *,
        ...
        request = models.GetSubscriptionsIDGrantsUpcomingRequest(
            id=id,
        )
    ...
    def pause(
        ...
        *,
        ...
        request = models.PostSubscriptionsIDPauseRequest(
            id=id,
    ...
    def list_pauses(
        ...
        *,
        ...
        request = models.GetSubscriptionsIDPausesRequest(
            id=id,
        )
    ...
    def resume(
        ...
        *,
        ...
        request = models.PostSubscriptionsIDResumeRequest(
            id=id,
