...
func (s *AlertLogs) PostAlertSearch(ctx context.Context, request components.TypesAlertLogFilter, opts ...operations.Option) (*components.DtoListAlertLogsResponse, error) {
