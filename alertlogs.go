...
func newAlertLogs(rootSDK *Flexprice, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *AlertLogs {
	return &AlertLogs{
		rootSDK:          rootSDK,
...
// Search - List alert logs by filter
// List alert logs by filter with optional expand for customer, wallet, and feature
func (s *AlertLogs) Search(ctx context.Context, request components.TypesAlertLogFilter, opts ...operations.Option) (*operations.PostAlertSearchResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/alert/search")
	if err != nil {
	...
	res := &operations.PostAlertSearchResponse{
